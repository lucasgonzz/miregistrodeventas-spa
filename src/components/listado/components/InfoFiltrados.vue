	...
	<b-col>
		<div class="card m-b-20" v-show="is_filter">
			...
			<div class="card-body">
				<div class="row m-b-10" v-show="is_filter">
					<div class="col-12 col-lg-3" v-show="filtro.mostrar != 'todos'">
						<ul class="list-group">
							<li class="list-group-item active-link">Mostrando solo artículos que</li>
					...
					<div class="col-12 col-lg-3">
						<ul class="list-group">
							<li class="list-group-item active-link">Ordenados de</li>
					...
					<div class="col-12 col-lg-3" v-show="filtro.providers.length != providers.length">
						<ul class="list-group">
							<li class="list-group-item active-link">De los proveedores</li>
							<li 
							v-for="provider in filtro.providers" 
							:key="provider.id"
					...
					<div class="col-12 col-lg-3" v-show="filtro.precio_entre.min && filtro.precio_entre.max">
						<ul class="list-group">
							<li class="list-group-item active-link">Con un precio entre</li>
			...
			<div class="card-footer">
				Artículos filtrados: {{ articlesLength }}
			</div>
		</div>
	</b-col>
</b-row>
