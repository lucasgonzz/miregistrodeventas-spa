...
<script>
import TitleComponent from '@/components/ventas/components/nav/Title'
import PreviusDays from '@/components/ventas/components/nav/PreviusDays'
import Buttons from '@/components/ventas/components/nav/Buttons'
export default {
